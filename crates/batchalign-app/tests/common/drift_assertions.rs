...
use batchalign_chat_ops::{ChatFile, DependentTier, UserDefinedDependentTier, Utterance};
...
/// against). Detection mirrors `batchalign_chat_ops::fa::utr::select_strategy`
/// — the canonical overlap-aware pattern.
pub fn check_utterance_bullet_monotonicity_preserved(parsed: &ChatFile) -> Result<(), String> {
    use batchalign_chat_ops::Linker;
    use batchalign_chat_ops::fa::utr::overlap_markers;
