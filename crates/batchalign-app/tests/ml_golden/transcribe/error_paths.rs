...
use batchalign_app::options::{AsrEngineName, WorTierPolicy};
...
async fn transcribe_direct_unsupported_asr_language_fails_cleanly() {
    ...
    let submission = batchalign_app::api::JobSubmission {
        ...
        lang: batchalign_app::api::LanguageSpec::try_from("vec").expect("valid vec language"),
        num_speakers: batchalign_app::api::NumSpeakers(1),
        files: vec![],
        media_files: vec![],
