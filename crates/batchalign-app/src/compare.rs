...
use batchalign_chat_ops::{DependentTier, Header, Line};
...
fn strip_mor_gra_tiers(chat_file: &mut batchalign_chat_ops::ChatFile) {
...
fn apply_media_header_from_main(
    main_file: &batchalign_chat_ops::ChatFile,
    gold_file: &mut batchalign_chat_ops::ChatFile,
) {
