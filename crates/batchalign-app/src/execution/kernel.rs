...
mod tests {
    ...
    impl WorkerGateway for FakeGateway {
        ...
        async fn morphotag_batch(
            ...
            _lang: &crate::api::LanguageCode3,
            _options: crate::execution::MorphotagRuntimeOptions<'_>,
            _progress_tx: Option<
                tokio::sync::mpsc::Sender<crate::types::worker_v2::ProgressEventV2>,
            >,
            _group_timeout: std::time::Duration,
        ) -> crate::text_batch::TextBatchFileResults {
            unreachable!("compare tests do not call morphotag_batch")
        }
        ...
        async fn morphotag_incremental(
            ...
            unreachable!("compare tests do not call morphotag_incremental")
        }
