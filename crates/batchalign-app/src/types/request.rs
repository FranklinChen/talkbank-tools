...
/// `batchalign_chat_ops::morphosyntax::stanza_languages::is_stanza_supported`.
...
fn is_stanza_supported_language(lang: &LanguageCode3) -> bool {
    let code = batchalign_chat_ops::LanguageCode::new(lang.as_ref());
    batchalign_chat_ops::morphosyntax::stanza_languages::is_stanza_supported(&code)
}

/// Format a help string listing supported Stanza languages for error messages.
fn stanza_supported_languages_help() -> String {
    batchalign_chat_ops::morphosyntax::stanza_languages::supported_iso3_codes()
        .chunks(10)
...
mod tests {
    ...
    fn morphotag_with_all_supported_languages_passes() {
        for code in batchalign_chat_ops::morphosyntax::stanza_languages::supported_iso3_codes() {
