...
#[cfg(feature = "server")]
pub use server::{
    create_app, create_app_with_prepared_workers, create_app_with_runtime, create_test_app, serve,
    serve_with_runtime,
};
#[cfg(feature = "server")]
...
pub(crate) fn chat_parser() -> batchalign_chat_ops::parse::TreeSitterParser {
    batchalign_chat_ops::parse::TreeSitterParser::new().expect("tree-sitter CHAT grammar must load")
}
