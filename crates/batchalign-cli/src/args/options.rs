        ...
        Commands::Align(a) => {
            ...
            Some(CommandOptions::Align(AlignOptions {
                ...
                review_level: match a.review_level {
                    super::commands::CliReviewLevel::None => {
                        batchalign_chat_ops::fa::ReviewLevel::None
                    }
                    super::commands::CliReviewLevel::LowConfidence => {
                        batchalign_chat_ops::fa::ReviewLevel::LowConfidence
                    }
                    super::commands::CliReviewLevel::All => {
                        batchalign_chat_ops::fa::ReviewLevel::All
                    }
                },
