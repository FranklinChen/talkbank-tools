...
use batchalign_app::config::{self, RuntimeLayout};
use batchalign_app::host_facts::{
    self, EffectiveConfig, HostFacts, HostFactsSource, RealHostFactsSource,
};
...
fn run_host_facts_only(
    format: &crate::args::DoctorFormat,
...
fn run_explain(knob: &str, format: &crate::args::DoctorFormat) -> Result<(), CliError> {
    ...
    match format {
        crate::args::DoctorFormat::Human => print_explanation_human(&explanation),
        crate::args::DoctorFormat::Json => {
...
fn explain_knob(
    knob: &str,
    cfg: &batchalign_app::config::ServerConfig,
    facts: &HostFacts,
...
fn build_host_facts_report_from(
    config: &batchalign_app::config::ServerConfig,
...
fn load_doctor_server_config() -> batchalign_app::config::ServerConfig {
...
mod tests {
    ...
    use batchalign_app::host_facts::ConfigOverrides;
    use batchalign_app::host_facts::test_helpers::apple_silicon_64gb;
