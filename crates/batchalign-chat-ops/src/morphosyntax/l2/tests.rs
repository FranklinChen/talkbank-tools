...
fn make_words(texts: &[&str]) -> Vec<String> {
...
fn make_ud_word(
    ...
    crate::nlp::UdWord {
        id: crate::nlp::UdId::Single(1),
        text: text.to_string(),
        lemma: lemma.to_string(),
        upos: crate::nlp::UdPunctable::Value(upos),
        xpos: None,
...
fn infer_advmod_when_adv_head_adj() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Adv, Some(UniversalPos::Adj), false),
...
fn infer_advmod_when_adv_head_verb() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Adv, Some(UniversalPos::Verb), false),
        Some(UdDeprel::new("advmod"))
    );
}
...
fn infer_amod_when_adj_head_noun() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Adj, Some(UniversalPos::Noun), false),
...
fn infer_det_when_det_head_noun() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Det, Some(UniversalPos::Noun), false),
...
fn infer_obj_when_noun_head_verb_no_case() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Noun, Some(UniversalPos::Verb), false),
...
fn infer_obl_when_noun_head_verb_with_case() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Noun, Some(UniversalPos::Verb), true),
...
fn infer_nmod_when_noun_head_noun() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Noun, Some(UniversalPos::Noun), false),
...
fn no_inference_for_uncommon_combination() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Verb, Some(UniversalPos::Noun), false),
        None
    );
}
...
fn no_inference_when_head_unknown() {
    assert_eq!(
        deprel::infer_deprel_from_pos(UniversalPos::Adv, None, false),
        None
    );
}
...
fn merge_upgrades_flat_deprel() {
    ...
    let result = merge_primary_secondary(&primary, mor, &LanguageCode::new("spa"));
...
fn ud_sentence_wake_up() -> crate::nlp::UdSentence {
    crate::nlp::UdSentence {
        words: vec![
            crate::nlp::UdWord {
                id: crate::nlp::UdId::Single(1),
                text: "wake".into(),
                lemma: "wake".into(),
                upos: crate::nlp::UdPunctable::Value(UniversalPos::Verb),
                xpos: None,
            ...
            crate::nlp::UdWord {
                id: crate::nlp::UdId::Single(2),
                text: "up".into(),
                lemma: "up".into(),
                upos: crate::nlp::UdPunctable::Value(UniversalPos::Adp),
                xpos: None,
                feats: None,
                head: 1,
...
fn non_phrasal_adp_case_stays_adp() {
    ...
    let sentence = crate::nlp::UdSentence {
        words: vec![crate::nlp::UdWord {
            id: crate::nlp::UdId::Single(1),
            text: "of".into(),
            lemma: "of".into(),
            upos: crate::nlp::UdPunctable::Value(UniversalPos::Adp),
...
fn phrasal_verb_particle_merge_sets_compound_prt_deprel() {
    ...
    let result =
        merge_primary_secondary_with_context(&primary, mor, &LanguageCode::new("eng"), Some(&ctx));
