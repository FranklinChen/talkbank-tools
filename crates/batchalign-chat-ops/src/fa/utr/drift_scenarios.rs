...
//! # Scenario taxonomy
//!
//! See the plan document (`docs/superpowers/plans/2026-04-22-segment-aware-utr.md`) Task 1.2.
//!
...
use crate::fa::utr::{AsrTimingToken, UtrResult, inject_utr_timing, overlap_markers};
