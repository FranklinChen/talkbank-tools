...
//! [`DecisionRecord`](crate::decisions::DecisionRecord) surface via
...
//! [`DecisionModule::Fa`](crate::decisions::DecisionModule::Fa) module
...
//!   [`MisalignmentBug`](crate::morphosyntax::outcome::MorOutcomeKind::MisalignmentBug).
//!
...
//! want a single `use batchalign_chat_ops::fa::outcome::*` bring-in.
