...
**Status:** Current
**Last modified:** 2026-04-08 15:08 EDT
...
short backchannels in dense-dialogue corpora (first seen in OCSC, 2026-04-08).

BA3 applies a **three-layer defence** in `batchalign-chat-ops/src/fa/utr.rs`
and `fa/orchestrate.rs`:
...
losing the hand-annotated context coverage. This was a real bug (a user,
2026-03-16, ACWT corpus). The `BulletSource` design preserves the correct
