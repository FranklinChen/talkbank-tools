...
**Status:** Current
**Last updated:** 2026-04-21 20:13 EDT
...
[`MorOutcome`](../../../crates/batchalign-chat-ops/src/morphosyntax/outcome.rs)
...
[`fa/outcome.rs`](../../../crates/batchalign-chat-ops/src/fa/outcome.rs)
...
([`UtteranceOutcome`](../../../crates/batchalign-cli/src/eval_cmd/l2_morphotag/types.rs))
...
- [`MorAlignableWordCount`](../../../../talkbank-tools/crates/talkbank-model/src/alignment/helpers/count.rs)
  — what `Utterance::mor_alignable_word_count()` returns.
- [`MorItemCount`](../../../../talkbank-tools/crates/talkbank-model/src/alignment/helpers/count.rs)
...
- `crates/batchalign-chat-ops/src/morphosyntax/outcome.rs` — `MorOutcome`,
  `MisalignmentDiagnostic`, `classify_not_applicable`
- `crates/batchalign-chat-ops/src/utseg.rs` — `UtsegOutcome`,
  `validate_utseg_response`
- `crates/batchalign-chat-ops/src/coref.rs` — `CorefOutcome`,
  `apply_coref_results_with_outcomes`
- `crates/batchalign-chat-ops/src/fa/outcome.rs` — FA decision
  vocabulary (re-exports)
- `crates/batchalign-chat-ops/src/fa/alignment.rs` — `FaAlignmentError`
  (typed error for FA response parsing)
- `crates/batchalign-chat-ops/src/decisions.rs` — `DecisionRecord`,
  `DecisionStrategy`, all per-module strategy enums

Invariant enforcement:

- `crates/batchalign-chat-ops/src/inject.rs` —
...
- `crates/batchalign-chat-ops/tests/mor_count_parity_reference_corpus.rs`
...
- `crates/batchalign-chat-ops/src/morphosyntax/outcome.rs`
...
`batchalign-chat-ops` using `chatter trim` to produce a minimal
