...
**Status:** Current
**Last updated:** 2026-04-28 08:49 EDT
...
hashes every `crates/batchalign-app/migrations/*.sql` and embeds the
...
| `crates/batchalign-app/src/types/config/` | `ServerConfig`, defaults, validation, state dir (split: `layout.rs`, `load.rs`, `resolve.rs`, `server.rs`, `tests.rs`) |
