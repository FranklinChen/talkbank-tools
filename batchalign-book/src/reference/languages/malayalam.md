...
**Status:** Current
**Last updated:** 2026-04-26 14:00 EDT
...
### E220 on Whisper digit emissions (resolved 2026-04-26)
...
`crates/batchalign-chat-ops/data/num2lang.json` covering 0-20,
decades 30-90, plus 100/1000 anchor words. The per-word Rust pass
in `crates/batchalign-app/src/pipeline/transcribe.rs::prepare_asr_chunks`
calls `expand_number(text, "mal")` on every word, converting digits
to their Malayalam-script word forms. After the 2026-04-26 Round-2
rework the Python IPC path no longer exists — Malayalam expansion
is end-to-end Rust. Tests at
`crates/batchalign-chat-ops/src/asr_postprocess/num2text.rs`
