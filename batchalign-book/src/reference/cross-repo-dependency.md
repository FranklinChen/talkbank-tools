...
```toml
# crates/batchalign-chat-ops/Cargo.toml
...
|-------|---------|---------|
| `talkbank-model` | `batchalign-chat-ops`, `batchalign-core` (PyO3) | CHAT data model, validation, alignment types |
| `talkbank-parser` | `batchalign-chat-ops`, `batchalign-core` (PyO3) | CHAT parsing (tree-sitter) |
| `talkbank-transform` | `batchalign-chat-ops` | Parse+validate pipeline, CHAT serialization |
