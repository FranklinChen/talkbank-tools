...
**Status:** Current
**Last updated:** 2026-04-22 20:05 EDT
...
| `tencent`, `aliyun`, `funaudio` | HK/Cantonese providers | Chinese variants only. |
...
| Language (ISO-639-3) | Default HF model_id | Added | Notes |
|---|---|---|---|
| `mal` (Malayalam) | `thennal/whisper-medium-ml` | 2026-04-22 | See "Evaluation below." |
...
sets vary, and some checkpoints (observed on 2026-04-22:
