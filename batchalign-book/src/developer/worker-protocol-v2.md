...
`crates/batchalign-app/src/worker/pool/shared_gpu/stdio.rs`,
`crates/batchalign-app/src/worker/pool/shared_gpu/tcp.rs`,
`crates/batchalign-app/src/worker/tcp_handle.rs` (carries
