...
|-------|----------|----------------|
| CLI args | `crates/batchalign-cli/src/args/commands.rs` — `AvqiArgs` | Positional input/output dirs, lang |
| Command definition | `crates/batchalign-app/src/commands/avqi.rs` | `CommandDefinition` impl, paired file discovery |
...
| Output writer | `crates/batchalign-app/src/commands/avqi.rs` | Writes `.avqi.txt` from typed metrics struct |
