...
3. `crates/batchalign-app/src/execution/` — recipe-driven dispatch (replaces old `compare_pipeline.rs`)
4. `crates/batchalign-app/src/planning/` — `build_job_plan()` for typed execution plans
