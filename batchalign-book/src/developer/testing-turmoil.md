...
**Status:** Current
**Last modified:** 2026-04-02 23:50 EDT
...
hyper. All live in `crates/batchalign-app/tests/turmoil_net.rs`:
...
cargo nextest run -p batchalign-app --test turmoil_net

# List available turmoil tests
cargo nextest list -p batchalign-app --test turmoil_net
```
...
| `real_app_health_reports_workers` | After 2026-03-30 incident: health endpoint must report actual worker state | None (accuracy) |
...
```toml
# crates/batchalign-app/Cargo.toml
[dev-dependencies]
turmoil = "0.7"
...
- [Tool evaluation: turmoil](../../docs/tool-evaluations/turmoil.md) — full
